package com.wise.MarketingPlatForm.report.domain.item.pivot.pivotmatrix.impl;
...
import com.wise.MarketingPlatForm.report.domain.item.pivot.pivotmatrix.SummaryDimensionComparator;
            ...
            for (UdfGroupParam udfGroupParam : udfGroupParams) {
                ...
                if (numValue != null) {
                    ...
                    case CUSTOM:
                        ...
                        selfSummaryValue.setValue(numValue);
                        break;
                    /*dogfoot 평균 계산식 변경 shlim 20220905 */
                    case AVG:
//                    	selfSummaryValue.setSum(numValue);
                    	selfSummaryValue.setValue(numValue);
                    	break;
