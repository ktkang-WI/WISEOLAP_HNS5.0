...
import com.wise.MarketingPlatForm.global.filter.GenericDataResourceContext;
import lombok.extern.slf4j.Slf4j;

@Slf4j
//public class FileBackedHashMapList extends LinkedList<HashMap> implements CloseableList<HashMap> {
	public class FileBackedHashMapList {
	...
	private static final String TEMP_FILE_PREFIX = FileBackedHashMapList.class.getSimpleName();
...
//	private List<FileBackedHashMapIterator> iterators;

	public FileBackedHashMapList() {
		this(defaultMaxSizeInMemory);
	}

	public FileBackedHashMapList(final int maxSizeInMemory) {
		this(maxSizeInMemory, DEFAULT_BASE_TEMP_FOLDER);
	}

	public FileBackedHashMapList(final File baseTempFolder) {
		this(defaultMaxSizeInMemory, baseTempFolder);
	}
	
	public FileBackedHashMapList(final int maxSizeInMemory, final File baseTempFolder) {
		super();
...
//		flushToBackingFile();
//		
//		final FileBackedHashMapIterator it = new FileBackedHashMapIterator(super.iterator(), maxSizeInMemory, totalSize, backingFile, bufferSize);
//		
//		if (iterators == null) {
...
//			for (FileBackedHashMapIterator it : iterators) {
...
//	}
//	
//	static class FileBackedHashMapIterator implements Iterator<JSONObject>, Closeable {
//		
//		private int index;
...
//
//		FileBackedHashMapIterator(final Iterator<JSONObject> it, final int maxSizeInMemory, final int totalSize, final File backingFile, final int bufferSize) {
//			this.it = it;
//			this.maxSizeInMemory = maxSizeInMemory;
