...
export const designerConfigItems = [
  ...
  {id: {id: 'defaultReportId', requiredNm: 'defaultReportNm'},
    title: '대시보드', label: ' 기본 보고서', btnLabel: '설정', type: 'favorit'},
  {id: {id: 'adHocDefaultReportId', requiredNm: 'adHocDefaultReportNm'},
    title: '비정형', label: '기본 보고서', btnLabel: '설정', type: 'favorit'},
  {id: {id: 'excelDefaultReportId', requiredNm: 'excelDefaultReportNm'},
    title: '스프레드', label: '기본 보고서', btnLabel: '설정', type: 'favorit'},
  {id: 'defaultItem', title: '기본 아이템',
    label: '아이템', type: 'favorit', btnLabel: '설정'},
  {id: 'defaultPalette', title: '기본 색상',
    label: '팔레트', type: 'favorit', btnLabel: '설정'},
